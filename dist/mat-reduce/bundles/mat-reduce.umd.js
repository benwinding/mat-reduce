(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/material'), require('rxjs/operators'), require('@angular/common'), require('@angular/forms'), require('@mat-datetimepicker/core'), require('ngx-color-picker'), require('ngx-material-timepicker'), require('ngx-quill'), require('rxjs'), require('uuid'), require('angular2-signaturepad'), require('quill'), require('quill-image-drop-module'), require('quill-image-compress'), require('quill-image-resize-module'), require('quill-html-edit-button'), require('@angular/cdk/keycodes')) :
    typeof define === 'function' && define.amd ? define('mat-reduce', ['exports', '@angular/core', '@angular/material', 'rxjs/operators', '@angular/common', '@angular/forms', '@mat-datetimepicker/core', 'ngx-color-picker', 'ngx-material-timepicker', 'ngx-quill', 'rxjs', 'uuid', 'angular2-signaturepad', 'quill', 'quill-image-drop-module', 'quill-image-compress', 'quill-image-resize-module', 'quill-html-edit-button', '@angular/cdk/keycodes'], factory) :
    (global = global || self, factory(global['mat-reduce'] = {}, global.ng.core, global.ng.material, global.rxjs.operators, global.ng.common, global.ng.forms, global.core$1, global.ngxColorPicker, global.ngxMaterialTimepicker, global.ngxQuill, global.rxjs, global.uuid, global.angular2Signaturepad, global.QuillNamespace, global.quillImageDropModule, global.ImageCompress, global.ImageResize, global.quillHtmlEditButton, global.ng.cdk.keycodes));
}(this, function (exports, core, material, operators, common, forms, core$1, ngxColorPicker, ngxMaterialTimepicker, ngxQuill, rxjs, uuid, angular2Signaturepad, QuillNamespace, quillImageDropModule, ImageCompress, ImageResize, quillHtmlEditButton, keycodes) { 'use strict';

    ImageCompress = ImageCompress && ImageCompress.hasOwnProperty('default') ? ImageCompress['default'] : ImageCompress;
    ImageResize = ImageResize && ImageResize.hasOwnProperty('default') ? ImageResize['default'] : ImageResize;
    ...
    ***************************************************************************** */
    ...
    var AppConfirmationDialogComponent = /** @class */ (function () {
        ...
        AppConfirmationDialogComponent.propDecorators = {
            okButton: [{ type: core.ViewChild, args: ['okButton', (/** @type {?} */ ({})),] }]
        };
    ...
    var FormBase = /** @class */ (function () {
        ...
        FormBase.propDecorators = {
            ...
            allowAutoComplete: [{ type: core.Input }],
    ...
    var LibFormDateComponent = /** @class */ (function (_super) {
        ...
        LibFormDateComponent.propDecorators = {
            placeholder: [{ type: core.Input }],
            isAfterToday: [{ type: core.Input }],
            AfterDate: [{ type: core.Input }]
        };
    ...
    var LibFormSignatureComponent = /** @class */ (function (_super) {
         ...
         */
        function () {
            this.autoCompleteObscureName = uuid.v1();
        };
        /**
         * @return {?}
         */
        ...
        LibFormSignatureComponent.propDecorators = {
            placeholder: [{ type: core.Input }],
            signaturePad: [{ type: core.ViewChild, args: ['signaturePad', (/** @type {?} */ ({ static: false })),] }],
    ...
    var Counter = /** @class */ (function () {
        function Counter(quill, options) {
            var _this = this;
            this.updateTrigger = new rxjs.Subject();
            this.quill = quill;
            ...
            this.updateTrigger.pipe(operators.debounceTime(2000)).subscribe((/**
             * @return {?}
             */
            function () {
                /** @type {?} */
    ...
    Quill.register('modules/htmlEditButton', quillHtmlEditButton.htmlEditButton);
    Quill.register('modules/counter', Counter);
    Quill.register('modules/counterChars', Counter);
    Quill.register('modules/counterKiloBytes', Counter);
    Quill.register('modules/imageDrop', quillImageDropModule.ImageDrop);
    ...
    var LibFormQuillEditorComponent = /** @class */ (function (_super) {
        ...
        function LibFormQuillEditorComponent() {
            ...
            _this.onContentChanged = new rxjs.Subject();
        ...
        function () {
            ...
            this.onContentChanged
                .pipe(operators.debounceTime(1000), operators.takeUntil(this.destroyed), operators.distinctUntilChanged())
                .subscribe((/**
             * @param {?} event
             * @return {?}
             */
        ...
        LibFormQuillEditorComponent.propDecorators = {
            quillModules: [{ type: core.Input }],
            maxImageWidth: [{ type: core.Input }],
            placeholder: [{ type: core.Input }]
        };
    ...
    var LibFormSelectObjectMultipleComponent = /** @class */ (function (_super) {
        ...
        LibFormSelectObjectMultipleComponent.propDecorators = {
            selectionObjects: [{ type: core.Input }],
            selectionKey: [{ type: core.Input }]
        };
    ...
    var LibFormToggleReversedComponent = /** @class */ (function (_super) {
        ...
        function LibFormToggleReversedComponent() {
            ...
            _this.yes = 'Yes';
            _this.no = 'No';
            _this.reversedControl = new forms.FormControl();
            return _this;
        }
        /**
         * @return {?}
        ...
        function () {
            ...
            this.internalControl.valueChanges
                .pipe(operators.takeUntil(this._destroyed), operators.debounceTime(100), operators.tap((/**
             * @return {?}
             */
            function () { return (_this.lockControl = true); })), operators.delay(100), operators.tap((/**
             * @param {?} value
             * @return {?}
             */
            function (value) { return _this.reversedControl.setValue(!value); })), operators.delay(100), operators.tap((/**
             * @return {?}
             */
    ...
    var LibFormTagMultipleComponent = /** @class */ (function (_super) {
        ...
        function LibFormTagMultipleComponent(snack) {
            ...
            _this.addedNewTag = new core.EventEmitter();
            _this.visible = true;
            _this.selectable = true;
            _this.addOnBlur = true;
            _this.separatorKeysCodes = [keycodes.ENTER, keycodes.COMMA];
            _this.inputTextControl = new forms.FormControl();
            _this.destroyed = new rxjs.Subject();
            return _this;
        }
        ...
        function () {
            var _this = this;
            this.filteredTagNames$ = this.inputTextControl.valueChanges.pipe(operators.startWith(null), operators.map((/**
             * @param {?} tagName
             * @return {?}
             */
            function (tagName) {
        ...
        LibFormTagMultipleComponent.propDecorators = {
            ...
            customValues: [{ type: core.Input }],
            removable: [{ type: core.Input }],
            filterStrategy: [{ type: core.Input }],
            addedNewTag: [{ type: core.Output }],
            textInput: [{ type: core.ViewChild, args: ['textInput', (/** @type {?} */ ({})),] }],
            matAutocompleteTrigger: [{ type: core.ViewChild, args: ['textInput', (/** @type {?} */ ({ read: material.MatAutocompleteTrigger })),] }],
            matAutocomplete: [{ type: core.ViewChild, args: ['auto', (/** @type {?} */ ({})),] }]
        };
    ...
    var LibFormAssigneeSelectorComponent = /** @class */ (function (_super) {
         ...
         */
        function (logString) {
            return rxjs.pipe(operators.takeUntil(this.destroyed), operators.auditTime(300), operators.tap((/**
             * @param {?} val
             * @return {?}
             */
        ...
        LibFormAssigneeSelectorComponent.propDecorators = {
            currentUser: [{ type: core.Input }],
            contractorsList: [{ type: core.Input }],
            staffList: [{ type: core.Input }]
        };
    ...
    var MatReduceModule = /** @class */ (function () {
        ...
        MatReduceModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        imports: __spread([material.MatIconModule], exportedModules$3),
    ...
    exports.FormArrayWithLabel = FormArrayWithLabel;
    exports.FormBase = FormBase;
    exports.FormBuilderTypedService = FormBuilderTypedService;
    exports.FormControlTypeSafe = FormControlTypeSafe;
    exports.FormControlWithLabel = FormControlWithLabel;
    exports.FormGroupTypeSafe = FormGroupTypeSafe;
    exports.MatReduceModule = MatReduceModule;
    exports.ɵa = AppConfirmationDialogComponent;
    exports.ɵb = ConfirmationService;
    exports.ɵba = MatReduceFormsComposedModule;
    exports.ɵbb = LibFormAssigneeSelectorComponent;
    exports.ɵc = MatReduceFormsUsing3rdPartyModule;
    exports.ɵd = LibFormColorComponent;
    exports.ɵe = FormBase;
    exports.ɵf = LibFormDateComponent;
    exports.ɵg = LibFormTimeComponent;
    exports.ɵh = LibFormSignatureComponent;
    exports.ɵi = LibFormQuillEditorComponent;
    exports.ɵj = MatReduceFormsUsingMaterialModule;
    exports.ɵk = LibFormNumberComponent;
    exports.ɵl = LibFormSelectObjectComponent;
    exports.ɵm = LibFormSelectObjectMultipleComponent;
    exports.ɵn = LibFormSelectStringComponent;
    exports.ɵo = LibFormSelectStringMultipleComponent;
    exports.ɵp = LibFormTagMultipleComponent;
    exports.ɵq = LibFormTagSingleComponent;
    exports.ɵr = LibFormTextAreaComponent;
    exports.ɵs = LibFormTextAreaDisabledComponent;
    exports.ɵt = LibFormTextClearableComponent;
    exports.ɵu = LibFormTextComponent;
    exports.ɵv = LibFormTextDisabledComponent;
    exports.ɵw = LibFormTextIconsComponent;
    exports.ɵx = LibFormTextPasswordComponent;
    exports.ɵy = LibFormToggleComponent;
    exports.ɵz = LibFormToggleReversedComponent;

    Object.defineProperty(exports, '__esModule', { value: true });

}));
//# sourceMappingURL=mat-reduce.umd.js.map
